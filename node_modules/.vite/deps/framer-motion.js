...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/array.mjs
...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/clamp.mjs
var clamp = (min, max, v) => {
  if (v > max)
    return max;
  if (v < min)
...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/format-error-message.mjs
function formatErrorMessage(message, errorCode) {
  return errorCode ? `${message}. For more information and steps for solving, visit https://motion.dev/troubleshooting/${errorCode}` : message;
}

// node_modules/motion-dom/node_modules/motion-utils/dist/es/errors.mjs
var warning = () => {
};
var invariant = () => {
};
...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/global-config.mjs
var MotionGlobalConfig = {};

// node_modules/motion-dom/node_modules/motion-utils/dist/es/is-numerical-string.mjs
var isNumericalString = (v) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(v);

// node_modules/motion-dom/node_modules/motion-utils/dist/es/is-object.mjs
function isObject(value) {
  return typeof value === "object" && value !== null;
}

// node_modules/motion-dom/node_modules/motion-utils/dist/es/is-zero-value-string.mjs
var isZeroValueString = (v) => /^0[^.\s]+$/u.test(v);

// node_modules/motion-dom/node_modules/motion-utils/dist/es/memo.mjs
...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/noop.mjs
var noop = (any) => any;

// node_modules/motion-dom/node_modules/motion-utils/dist/es/pipe.mjs
var combineFunctions = (a, b) => (v) => b(a(v));
var pipe = (...transformers) => transformers.reduce(combineFunctions);

// node_modules/motion-dom/node_modules/motion-utils/dist/es/progress.mjs
var progress = (from, to, value) => {
  const toFromDifference = to - from;
  return toFromDifference === 0 ? 1 : (value - from) / toFromDifference;
};

// node_modules/motion-dom/node_modules/motion-utils/dist/es/subscription-manager.mjs
...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/time-conversion.mjs
var secondsToMilliseconds = (seconds) => seconds * 1e3;
var millisecondsToSeconds = (milliseconds) => milliseconds / 1e3;

// node_modules/motion-dom/node_modules/motion-utils/dist/es/velocity-per-second.mjs
function velocityPerSecond(velocity, frameDuration) {
  return frameDuration ? velocity * (1e3 / frameDuration) : 0;
}

// node_modules/motion-dom/node_modules/motion-utils/dist/es/warn-once.mjs
...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/cubic-bezier.mjs
...
// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/modifiers/mirror.mjs
var mirrorEasing = (easing) => (p) => p <= 0.5 ? easing(2 * p) / 2 : (2 - easing(2 * (1 - p))) / 2;

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/modifiers/reverse.mjs
var reverseEasing = (easing) => (p) => 1 - easing(1 - p);

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/back.mjs
var backOut = cubicBezier(0.33, 1.53, 0.69, 0.99);
var backIn = reverseEasing(backOut);
var backInOut = mirrorEasing(backIn);

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/anticipate.mjs
var anticipate = (p) => (p *= 2) < 1 ? 0.5 * backIn(p) : 0.5 * (2 - Math.pow(2, -10 * (p - 1)));

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/circ.mjs
var circIn = (p) => 1 - Math.sin(Math.acos(p));
var circOut = reverseEasing(circIn);
var circInOut = mirrorEasing(circIn);

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/ease.mjs
var easeIn = cubicBezier(0.42, 0, 1, 1);
var easeOut = cubicBezier(0, 0, 0.58, 1);
var easeInOut = cubicBezier(0.42, 0, 0.58, 1);

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/utils/is-easing-array.mjs
var isEasingArray = (ease2) => {
  return Array.isArray(ease2) && typeof ease2[0] !== "number";
};

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/utils/is-bezier-definition.mjs
var isBezierDefinition = (easing) => Array.isArray(easing) && typeof easing[0] === "number";

// node_modules/motion-dom/node_modules/motion-utils/dist/es/easing/utils/map.mjs
var easingLookup = {
  linear: noop,
  easeIn,
  easeInOut,
...
var animateMotionValue = (name, value, target, transition = {}, element, isHandoff) => (onComplete) => {
  ...
  elapsed = elapsed - secondsToMilliseconds2(delay2);
  const options = {
...
function getVelocity(history, timeDelta) {
  ...
  const time2 = millisecondsToSeconds2(lastPoint.timestamp - timestampedPoint.timestamp);
  if (time2 === 0) {
    return { x: 0, y: 0 };
  }
...
function measure(container, target = container, info) {
  ...
  if (true) {
    if (container && target && target !== container) {
      warnOnce2(getComputedStyle(container).position !== "static", "Please ensure that the container has a non-static position, like 'relative', 'fixed', or 'absolute' to ensure scroll offset is calculated correctly.");
    }
  }
}
...
function useScroll({ container, target, ...options } = {}) {
  ...
  (0, import_react32.useEffect)(() => {
    if (needsStart.current) {
      invariant2(!isRefPending(container), "Container ref is defined but not hydrated", "use-scroll-ref");
...
function useElementScroll(ref) {
  if (true) {
    warnOnce2(false, "useElementScroll is deprecated. Convert to useScroll({ container: ref }).");
  }
...
function useViewportScroll() {
  if (true) {
    warnOnce2(false, "useViewportScroll is deprecated. Convert to useScroll().");
  }
  return useScroll();
}
...
function useReducedMotion() {
  ...
  if (true) {
    warnOnce2(shouldReduceMotion !== true, "You have Reduced Motion enabled on your device. Animations may not appear as expected.", "reduced-motion-disabled");
  }
...
function addKeyframes(sequence, keyframes2, easing, offset, startTime, endTime) {
  ...
  for (let i = 0; i < keyframes2.length; i++) {
    sequence.push({
      ...
      easing: getEasingForSegment2(easing, i)
    });
  }
}
  ...
  for (let i = 0; i < sequence.length; i++) {
    ...
    const resolveValueSequence = (valueKeyframes, valueTransition, valueSequence, elementIndex = 0, numSubjects = 0) => {
      ...
      if (numKeyframes <= 2 && createGenerator) {
        ...
        if (duration !== void 0) {
          springTransition.duration = secondsToMilliseconds2(duration);
        }
      ...
      if (repeat) {
        ...
        for (let repeatIndex = 0; repeatIndex < repeat; repeatIndex++) {
          ...
          for (let keyframeIndex = 0; keyframeIndex < originalKeyframes.length; keyframeIndex++) {
            ...
            ease2.push(keyframeIndex === 0 ? "linear" : getEasingForSegment2(originalEase, keyframeIndex - 1));
          }
        }
  ...
  (0, import_react43.useEffect)(() => {
    frame.postRender(() => frame.postRender(() => {
      if (forcedRenderCount !== unlockOnFrameRef.current)
        return;
      MotionGlobalConfig2.instantAnimations = false;
    }));
  }, [forcedRenderCount]);
  return (callback) => {
    startInstantLayoutTransition(() => {
      MotionGlobalConfig2.instantAnimations = true;
      forceUpdate();
      callback();
...
var AnimateSharedLayout = ({ children }) => {
  React4.useEffect(() => {
    invariant2(false, "AnimateSharedLayout is deprecated: https://www.framer.com/docs/guide-upgrade/##shared-layout-animations");
  }, []);
...
function useInvertedScale(scale2) {
  ...
  invariant2(!!(scale2 || visualElement), "If no scale values are provided, useInvertedScale must be used within a child of another motion component.");
  warning2(hasWarned3, "useInvertedScale is deprecated and will be removed in 3.0. Use the layout prop instead.");
  hasWarned3 = true;
  if (scale2) {
...
function checkReorder(order, value, offset, velocity) {
  ...
  if (nextOffset === 1 && item.layout.max + offset > nextItemCenter || nextOffset === -1 && item.layout.min + offset < nextItemCenter) {
    return moveItem2(order, index, index + nextOffset);
  }
  return order;
}
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  invariant2(Boolean(values), "Reorder.Group must be provided a values prop", "reorder-values");
  const context = {
    axis,
...
function ReorderItemComponent({ children, style: style2 = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  invariant2(Boolean(context), "Reorder.Item must be a child of Reorder.Group", "reorder-item-child");
