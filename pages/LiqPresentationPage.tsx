...
interface LiqPresentationProps {
  isOpen?: boolean;
  onClose?: () => void;
  asModal?: boolean;
}

export default function LiqPresentation({ isOpen = true, onClose, asModal = false }: LiqPresentationProps) {
  ...
  const slides: PresentationSlide[] = useMemo(
    () => [
      { id: 1, titleKey: '', imageUrl: '../images/originals/1.webp', descriptionKey: '' },
      { id: 2, titleKey: '', imageUrl: '../images/originals/2.webp', descriptionKey: '' },
      { id: 3, titleKey: '', imageUrl: '../images/originals/3.webp', descriptionKey: '' },
      { id: 4, titleKey: '', imageUrl: '../images/originals/5.webp', descriptionKey: '' },
      { id: 5, titleKey: '', imageUrl: '../images/originals/6.webp', descriptionKey: '' },
      { id: 6, titleKey: '', imageUrl: '../images/originals/7.webp', descriptionKey: '' },
      { id: 7, titleKey: '', imageUrl: '../images/originals/8.webp', descriptionKey: '' },
      { id: 8, titleKey: '', imageUrl: '../images/originals/9.webp', descriptionKey: '' },
      { id: 9, titleKey: '', imageUrl: '../images/originals/10.webp', descriptionKey: '' },
      { id: 10, titleKey: '', imageUrl: '../images/originals/11.webp', descriptionKey: '' },
      { id: 11, titleKey: '', imageUrl: '../images/originals/12.webp', descriptionKey: '' },
      { id: 12, titleKey: '', imageUrl: '../images/originals/13.webp', descriptionKey: '' },
      { id: 13, titleKey: '', imageUrl: '../images/originals/14.webp', descriptionKey: '' },
      { id: 14, titleKey: '', imageUrl: '../images/originals/15.webp', descriptionKey: '' },
      { id: 15, titleKey: '', imageUrl: '../images/originals/16.webp', descriptionKey: '' },
      { id: 16, titleKey: '', imageUrl: '../images/originals/17.webp', descriptionKey: '' },
      { id: 17, titleKey: '', imageUrl: '../images/originals/18.webp', descriptionKey: '' },
      { id: 18, titleKey: '', imageUrl: '../images/originals/19.webp', descriptionKey: '' },
      { id: 19, titleKey: '', imageUrl: '../images/originals/20.webp', descriptionKey: '' },
      { id: 20, titleKey: '', imageUrl: '../images/originals/21.webp', descriptionKey: '' },
      { id: 21, titleKey: '', imageUrl: '../images/originals/22.webp', descriptionKey: '' },
      { id: 22, titleKey: '', imageUrl: '../images/originals/23.webp', descriptionKey: '' },
    ],
    []
  );
